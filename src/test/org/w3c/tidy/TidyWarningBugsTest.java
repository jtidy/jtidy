...
public class TidyWarningBugsTest extends TidyTestCase
{
    ...
    {
        // line 8 column 2 - Warning: <script> inserting "type" attribute
    ...
    {
        /*
         * line 11 column 3 - Warning: <table> lacks "summary" attribute Info: Doctype given is "-//W3C//DTD HTML
         * 3.2//EN" Info: Document content looks like HTML 3.2 1 warning, 0 errors were found!
         */
    ...
    public void test435917() throws Exception
    {
        ...
        // line 8 column 1 - Warning: inserting implicit <form>
        // line 10 column 1 - Warning: <input> attribute with missing trailing quote mark
        // line 8 column 1 - Warning: missing </form>
        // line 8 column 1 - Warning: <form> lacks "action" attribute
        // Info: Doctype given is "-//W3C//DTD HTML 4.01 Transitional//EN"
        // Info: Document content looks like HTML 4.01 Transitional
    ...
    {
        // line 1 column 1 - Warning: missing <!DOCTYPE> declaration
        // line 5 column 1 - Warning: <input> isn't allowed in <body> elements
        // line 6 column 3 - Warning: inserting implicit <form>
        // line 6 column 3 - Warning: missing </form>
        // line 6 column 3 - Warning: <form> lacks "action" attribute
        // Info: Document content looks like HTML 3.2
        // 5 warnings, 0 errors were found!
    ...
    public void test516370() throws Exception
    {
        ...
        // line 8 column 1 - Warning: <h2> ID "_ValidID2" uses XML ID syntax
        // line 9 column 1 - Warning: <h2> ID ":ValidID3" uses XML ID syntax
        // line 10 column 1 - Warning: <h2> attribute "id" has invalid value ".InvalidID1"
        // line 11 column 1 - Warning: <h2> attribute "id" has invalid value "2InvalidID2"
