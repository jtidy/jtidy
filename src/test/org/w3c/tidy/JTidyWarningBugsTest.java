...
public class JTidyWarningBugsTest extends TidyTestCase
{
    ...
    {
        Tidy tidy = executeTidyTest("j828316.html");
        assertTrue("Test failed, false warnings are reported", tidy.getParseWarnings() == 0);
        assertTrue("Test failed, false errors are reported", tidy.getParseErrors() == 0);
    }
