...
public class TagTable
{
    ...
    private static final Dict[] TAGS = {
        ...
        new Dict("link", Dict.VERS_ALL, (Dict.CM_HEAD | Dict.CM_EMPTY), null, CheckAttribsImpl.CHECK_LINK),
        new Dict("meta", Dict.VERS_ALL, (Dict.CM_HEAD | Dict.CM_EMPTY), null, CheckAttribsImpl.CHECK_META),
        new Dict("style", Dict.VERS_FROM32, Dict.CM_HEAD, ParserImpl.getParseScript(), CheckAttribsImpl.CHECK_STYLE),
        new Dict(
            "script",
            Dict.VERS_FROM32,
            (Dict.CM_HEAD | Dict.CM_MIXED | Dict.CM_BLOCK | Dict.CM_INLINE),
            ParserImpl.getParseScript(),
            CheckAttribsImpl.CHECK_SCRIPT),
        new Dict(
            "server",
            Dict.VERS_NETSCAPE,
            (Dict.CM_HEAD | Dict.CM_MIXED | Dict.CM_BLOCK | Dict.CM_INLINE),
        ...
        new Dict("form", Dict.VERS_ALL, Dict.CM_BLOCK, ParserImpl.getParseBlock(), CheckAttribsImpl.CHECK_FORM),
        ...
        new Dict("table", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.getParseTableTag(), CheckAttribsImpl.CHECK_TABLE),
        new Dict("hr", Dict.VERS_ALL, (Dict.CM_BLOCK | Dict.CM_EMPTY), null, CheckAttribsImpl.CHECK_HR),
        ...
        new Dict(
            ...
            Dict.CM_TABLE,
            ParserImpl.getParseInline(),
            CheckAttribsImpl.CHECK_CAPTION),
        ...
        new Dict(
            ...
            ParserImpl.getParseBlock(),
            CheckAttribsImpl.CHECK_TABLECELL),
        new Dict(
            "th",
            Dict.VERS_FROM32,
            (Dict.CM_ROW | Dict.CM_OPT | Dict.CM_NO_INDENT),
        ...
        new Dict("a", Dict.VERS_ALL, Dict.CM_INLINE, ParserImpl.getParseInline(), CheckAttribsImpl.CHECK_ANCHOR),
        new Dict("br", Dict.VERS_ALL, (Dict.CM_INLINE | Dict.CM_EMPTY), null, null),
        new Dict("img", Dict.VERS_ALL, (Dict.CM_INLINE | Dict.CM_IMG | Dict.CM_EMPTY), null, CheckAttribsImpl.CHECK_IMG),
        new Dict(
            "object",
            Dict.VERS_HTML40,
        ...
        new Dict("noscript", Dict.VERS_HTML40, (Dict.CM_BLOCK | Dict.CM_INLINE | Dict.CM_MIXED), ParserImpl
            .getParseBlock(), null),
        ...
        new Dict("nolayer", Dict.VERS_NETSCAPE, (Dict.CM_BLOCK | Dict.CM_INLINE | Dict.CM_MIXED), ParserImpl
            .getParseBlock(), null),
        new Dict("ilayer", Dict.VERS_NETSCAPE, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("map", Dict.VERS_FROM32, Dict.CM_INLINE, ParserImpl.getParseBlock(), CheckAttribsImpl.CHECK_MAP),
        new Dict("area", Dict.VERS_ALL, (Dict.CM_BLOCK | Dict.CM_EMPTY), null, CheckAttribsImpl.CHECK_AREA),
