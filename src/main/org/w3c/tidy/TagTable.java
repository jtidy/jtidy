...
public class TagTable
{
    ...
    private static final Dict[] TAGS = {
        ...
        new Dict("style", Dict.VERS_FROM32, Dict.CM_HEAD, ParserImpl.getParseScript(), TagCheckImpl.STYLE),
        new Dict(
            "script",
            Dict.VERS_FROM32,
        ...
        new Dict("hr", Dict.VERS_ALL, (Dict.CM_BLOCK | Dict.CM_EMPTY), null, TagCheckImpl.HR),
        ...
        new Dict("nolayer", Dict.VERS_NETSCAPE, (Dict.CM_BLOCK | Dict.CM_INLINE | Dict.CM_MIXED), ParserImpl
            .getParseBlock(), null),
        new Dict("ilayer", Dict.VERS_NETSCAPE, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("map", Dict.VERS_FROM32, Dict.CM_INLINE, ParserImpl.getParseBlock(), TagCheckImpl.MAP),
        new Dict("area", Dict.VERS_ALL, (Dict.CM_BLOCK | Dict.CM_EMPTY), null, TagCheckImpl.AREA),
