...
public class TagTable
{
    ...
    private static final Dict[] TAGS = {
        new Dict(
            ...
            TagCheckImpl.HTML),
        new Dict("head", Dict.VERS_ALL, (Dict.CM_HTML | Dict.CM_OPT | Dict.CM_OMITST), ParserImpl.getParseHead(), null),
        ...
        new Dict("link", Dict.VERS_ALL, (Dict.CM_HEAD | Dict.CM_EMPTY), null, TagCheckImpl.LINK),
        new Dict("meta", Dict.VERS_ALL, (Dict.CM_HEAD | Dict.CM_EMPTY), null, TagCheckImpl.META),
        new Dict(
            "style",
        ...
        new Dict("frameset", Dict.VERS_FRAMESET, (Dict.CM_HTML | Dict.CM_FRAMES), ParserImpl.getParseFrameSet(), null),
        ...
        new Dict("form", Dict.VERS_ALL, Dict.CM_BLOCK, ParserImpl.getParseBlock(), TagCheckImpl.FORM),
        ...
        new Dict(
            ...
            null),
        new Dict("table", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.getParseTableTag(), TagCheckImpl.TABLE),
        new Dict(
            "hr",
        ...
        new Dict(
            ...
            ParserImpl.getParseBlock(),
            null),
        new Dict("caption", Dict.VERS_FROM32, Dict.CM_TABLE, ParserImpl.getParseInline(), TagCheckImpl.CAPTION),
        ...
        new Dict("a", Dict.VERS_ALL, Dict.CM_INLINE, ParserImpl.getParseInline(), TagCheckImpl.ANCHOR),
        new Dict("br", Dict.VERS_ALL, (Dict.CM_INLINE | Dict.CM_EMPTY), null, null),
        new Dict("img", Dict.VERS_ALL, (Dict.CM_INLINE | Dict.CM_IMG | Dict.CM_EMPTY), null, TagCheckImpl.IMG),
        new Dict(
            "object",
            Dict.VERS_HTML40,
            ...
            ParserImpl.getParseBlock(),
            null),
        new Dict("applet", Dict.VERS_LOOSE, (Dict.CM_OBJECT | Dict.CM_IMG | Dict.CM_INLINE | Dict.CM_PARAM), ParserImpl
            .getParseBlock(), null),
        new Dict("servlet", Dict.VERS_SUN, (Dict.CM_OBJECT | Dict.CM_IMG | Dict.CM_INLINE | Dict.CM_PARAM), ParserImpl
            .getParseBlock(), null),
        ...
        new Dict("noframes", Dict.VERS_IFRAME, (Dict.CM_BLOCK | Dict.CM_FRAMES), ParserImpl.getParseNoFrames(), null),
        new Dict(
            "noscript",
            (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC),
            ...
            ParserImpl.getParseBlock(),
            null),
        new Dict("b", (short) (Dict.VERS_ALL & ~Dict.VERS_BASIC), Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("i", (short) (Dict.VERS_ALL & ~Dict.VERS_BASIC), Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("u", Dict.VERS_LOOSE, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("tt", (short) (Dict.VERS_ALL & ~Dict.VERS_BASIC), Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        ...
        new Dict("optgroup", (short) (Dict.VERS_HTML40 & ~Dict.VERS_BASIC), (Dict.CM_FIELD | Dict.CM_OPT), ParserImpl
            .getParseOptGroup(), null),
        ...
        new Dict("ruby", Dict.VERS_XHTML11, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("rbc", Dict.VERS_XHTML11, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("rtc", Dict.VERS_XHTML11, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("rb", Dict.VERS_XHTML11, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("rt", Dict.VERS_XHTML11, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("", Dict.VERS_XHTML11, Dict.CM_INLINE, ParserImpl.getParseInline(), null),
        new Dict("rp", Dict.VERS_XHTML11, Dict.CM_INLINE, ParserImpl.getParseInline(), null),};
